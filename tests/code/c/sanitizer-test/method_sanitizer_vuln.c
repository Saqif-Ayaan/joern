...
size_t clamp_vuln(size_t n) {
    return n;
}

void with_method_sanitizer_vuln(size_t len, char *src) {
    size_t sanitized_len = clamp_vuln(len);  /* If modeled as sanitizer, validator should reject this impl */
